...
namespace AdventOfCode2023.Tests.Day03Part01;
...
public class Day03Part01
{
    ...
    public Day03Part01(ITestOutputHelper testOutputHelper)
    {
        _testOutputHelper = testOutputHelper;
        _currentDirectory = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Tests", "Day03Part01");
    }
