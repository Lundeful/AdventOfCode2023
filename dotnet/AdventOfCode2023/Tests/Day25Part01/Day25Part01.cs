...
namespace AdventOfCode2023.Tests.Day25Part01;
...
public class Day25Part01
{
    ...
    public Day25Part01(ITestOutputHelper testOutputHelper)
    {
        _testOutputHelper = testOutputHelper;
        _currentDirectory = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Tests", "Day25Part01");
    }
