...
namespace AdventOfCode2023.Tests.Day21Part01;
...
public class Day21Part01
{
    ...
    public Day21Part01(ITestOutputHelper testOutputHelper)
    {
        _testOutputHelper = testOutputHelper;
        _currentDirectory = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Tests", "Day21Part01");
    }
