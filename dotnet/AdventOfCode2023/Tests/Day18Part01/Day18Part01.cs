...
namespace AdventOfCode2023.Tests.Day18Part01;
...
public class Day18Part01
{
    ...
    public Day18Part01(ITestOutputHelper testOutputHelper)
    {
        _testOutputHelper = testOutputHelper;
        _currentDirectory = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Tests", "Day18Part01");
    }
