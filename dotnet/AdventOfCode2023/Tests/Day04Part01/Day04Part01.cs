...
namespace AdventOfCode2023.Tests.Day04Part01;
...
public class Day04Part01
{
    ...
    public Day04Part01(ITestOutputHelper testOutputHelper)
    {
        _testOutputHelper = testOutputHelper;
        _currentDirectory = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Tests", "Day04Part01");
    }
