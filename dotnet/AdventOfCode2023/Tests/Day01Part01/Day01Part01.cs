...
namespace AdventOfCode2023.Tests.Day01Part01;
...
public class Day01Part01
{
    ...
    public Day01Part01(ITestOutputHelper testOutputHelper)
    {
        _testOutputHelper = testOutputHelper;
        _currentDirectory = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Tests", "Day01Part01");
    }
