...
namespace AdventOfCode2023.Tests.Day06Part01;
...
public class Day06Part01
{
    ...
    public Day06Part01(ITestOutputHelper testOutputHelper)
    {
        _testOutputHelper = testOutputHelper;
        _currentDirectory = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Tests", "Day06Part01");
    }
